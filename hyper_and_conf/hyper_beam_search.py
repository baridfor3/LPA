...
class SequenceBeamSearch(object):
    ...
    """
        ...
        max_length_norm = _length_normalization(self.alpha,
    ...
    """
        ...
        finished_state = self._get_new_finished_state(state, new_seq,
                                                      new_log_probs)
    ...
    """
        ...
        top_alive_seq, top_alive_log_probs, top_alive_cache = _gather_topk_beams(
            [new_seq, new_log_probs, new_cache], new_log_probs,
    ...
    """
        ...
        length_norm = _length_normalization(self.alpha,
                                            i + 1,
                                            dtype=self.dtype)
        ...
        finished_flags = tf.concat([finished_flags, new_finished_flags],
                                   axis=1)
        ...
        top_finished_seq, top_finished_scores, top_finished_flags = (
            _gather_topk_beams([finished_seq, finished_scores, finished_flags],
                               finished_scores, self.batch_size,
                               self.beam_size))
